...
<div class="row">
    <div class="col-md-12 pt-1">
        <h2 class="admin_title">Edit new product</h2>
    </div>    
</div>
...
<div class="row">
    <div class="col-md-12 pt-4 pb-4">
            {!! Form::model( $product, [
                'method' => 'PATCH',
                'action' => array('BackEnd\ProductController@update', $product->id),
                'role' => 'form', 'class' => '',
                'files' => true
            ]) !!}      
                <div class="form-row">
                    ...
                    <div class="col-md-5">
                        <img src="{{ asset('/storage/products/256/'.$product->picture) }}" width="120" alt="...">    
                    </div>                       
                </div>   
                <div class="form-row">
                    <div class="col-md-7 mb-3">
                ...
                <div class="form-row">
                    <div class="col-md-3 mb-3">
                        ...
                        {!! Form::text('amount', old('amount'), ['class' => "form-control $valid", 'placeholder' => 'Amount']) !!}
                        <div class="invalid-feedback"> {{ $errors->first('amount') }} </div>
                    </div>       
                    <div class="col-md-4 mb-3">
                        @php $valid = $errors->has('unit_price')?'is-invalid':''; @endphp
                        <label for="unit_price">Unit Price</label>
                        {!! Form::text('unit_price', old('unit_price'), ['class' => "form-control $valid", 'placeholder' => 'Unit Price']) !!}
                ...
                <div class="form-row">
                    <div class="col-md-7 mb-3">
                        ...
                        {!! Form::text('order', old('order'), ['class' => "form-control $valid", 'placeholder' => 'Order']) !!}
